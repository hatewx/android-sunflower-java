...
The project contains two app modules:

- `app`: the current upstream Kotlin/Compose implementation.
- `app-java`: the Java/View implementation maintained by this fork.
